    ...
    return (
        <>
            {!isLoading ?
                ...
                >
                    <img src={data?.images[0] ? data?.images[0] : ''} className='md:w-[20vw]  md:h-[260px] rounded absolute -top-16 md:right-16 lg:right-36 bg-white object-cover' />
                    <div className='w-[400px] font-serif italic p-6 text-black gap-6'>
